...
class ImageClipper:
	...
	def draw_overlay(self):
		...
		if self.crop_rect:
			...
			cv2.rectangle(canvas, (display_left, display_top), (display_right, display_bottom), (0, 255, 0), 2)
			...
			if crop_height > 0:
				...
				cv2.putText(canvas, ratio_text, (10, canvas_height - 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
		...
		cv2.putText(canvas, help_text, (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
